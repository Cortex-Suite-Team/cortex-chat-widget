/* cortex-chat-widget loader build: sdk=1.1.20 builtAt=2026-06-01T19:11:26.165Z */
"use strict";
(() => {
  ...
  var CortexError = class extends Error {
    constructor(code2, message, retryable, fatal) {
      super(message);
  ...
  function makeError(code2, message) {
    const entry = CATALOG_MAP.get(code2) ?? { code: code2, retryable: false, fatal: false };
    return new CortexError(entry.code, message, entry.retryable, entry.fatal);
  }
  function lookupError(code2) {
  ...
  async function exchangeApiKey(apiKey, fetchFn, authBaseUrl = DEFAULT_AUTH_URL, workerRef, frontendUuid) {
    ...
    if (!res.ok) {
      ...
      const code2 = typeof body["error"] === "string" ? body["error"] : "auth_invalid";
      const message = typeof body["message"] === "string" ? body["message"] : "API key rejected";
      throw makeError(code2, message);
    }
    return res.json();
  }
  ...
  function normalizeAuthBaseUrl(authUrl) {
    ...
    for (const knownPath of [AUTH_TOKEN_PATH, AUTH_REFRESH_PATH]) {
      if (normalized.endsWith(knownPath)) {
        const base2 = normalized.slice(0, -knownPath.length);
        console.warn(`[CortexSDK] authUrl must be a base URL (origin only), not a full endpoint. Received "${authUrl}" \u2014 "${knownPath}" has been stripped automatically. Pass the base URL only, e.g., "${base2}".`);
        normalized = base2;
        break;
      }
    }
  ...
  function createSession(callbacks) {
    ...
    function updateSessionStateFromMessage(msg) {
      ...
      if (msg.type === "system::error") {
        const code2 = typeof msg.payload["code"] === "string" ? msg.payload["code"] : "session_terminal";
        if (lookupError(code2)?.fatal) {
    ...
    function handleSystemError(payload) {
      const code2 = typeof payload["code"] === "string" ? payload["code"] : "session_terminal";
      const message = typeof payload["message"] === "string" ? payload["message"] : "Runtime error";
      const entry = lookupError(code2);
      const fatal = entry?.fatal ?? false;
      const err = makeError(code2, message);
      if (fatal) {
  ...
  var CortexClient = class {
    ...
    connect() {
      ...
      this._connectPromise = this._connectInternal().catch((error2) => {
    ...
    _handleClose(code2, reason) {
      ...
      if (this._sessionOpenWaiter) {
        this._rejectSessionOpen(code2 === 4001 ? makeError("auth_invalid", "Session open failed during authentication") : makeError("transport_protocol_violation", reason ? `Connection closed before session opened (${reason})` : "Connection closed before session opened"));
        this._channelState = code2 === 4001 ? "AUTH_FAILED" : "CLOSED";
        this._stopBackgroundActivity();
        return;
      }
      if (code2 === 4001) {
    ...
    _handleSessionMessage(msg) {
      ...
      if (msg.type === "system::opened") {
        ...
        const code2 = typeof msg.payload["code"] === "string" ? msg.payload["code"] : "session_not_ready";
        const message = typeof msg.payload["message"] === "string" ? msg.payload["message"] : "Session open failed";
        this._rejectSessionOpen(makeError(code2, message));
      }
  ...
  function createWidgetError(code2, message, cause) {
    return new WidgetError(code2, message, cause);
  }
  function toWidgetError(error2, fallbackCode = "widget_error", fallbackMessage = "Unexpected widget error") {
    if (error2 instanceof WidgetError) {
      return {
        code: error2.code,
...
`;
  ...
  function createChatError(code2, message, source, details) {
    return { code: code2, message, source, details };
  }
  function createControllerError(code2, message, source, details) {
    return new ControllerError(code2, message, {
      ...source ? { source } : {},
      ...details ?? {}
    });
  }
  function errorFromUnknown(error2, fallbackCode = "controller_error", source) {
    if (error2 instanceof ControllerError) {
      return createChatError(error2.code, error2.message, source, error2.details);
    }
    if (error2 instanceof Error) {
      return createChatError(fallbackCode, error2.message, source);
    }
  ...
  function createEscalationController(options) {
    ...
    function emitError(error2) {
      emit({ type: "error", error: error2 });
    }
    ...
    async function reply(action, content) {
      try {
        ...
        const viewModel = errorFromUnknown(error2, "escalation_reply_failed", "escalation");
        emitError(viewModel);
        throw error2;
      }
    }
  ...
  function createTranscriptStore(options = {}) {
    ...
    function buildMalformedPartialMessage(message) {
      const error2 = createChatError("partial_missing_turn_id", "chat::partial is missing payload.turn_id", "chat::partial", { type: message.type });
  ...
  function createChatController(options) {
    ...
    async function runAction(action) {
      try {
        ...
        if (!(error2 instanceof Error)) {
          setError(errorFromUnknown(error2));
        }
        throw error2;
      }
    }
  ...
  // ../sdk-ui/node_modules/dompurify/dist/purify.es.mjs
  ...
  function createDOMPurify() {
    ...
    const currentScript2 = originalDocument.currentScript;
    ...
    const _parseConfig = function _parseConfig2() {
      ...
      if (cfg.TRUSTED_TYPES_POLICY) {
        ...
        if (trustedTypesPolicy === void 0) {
          trustedTypesPolicy = _createTrustedTypesPolicy(trustedTypes, currentScript2);
        }
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/common/utils.mjs
  var utils_exports = {};
  ...
  // ../sdk-ui/node_modules/mdurl/index.mjs
  var mdurl_exports = {};
  ...
  // ../sdk-ui/node_modules/mdurl/lib/decode.mjs
  var decodeCache = {};
  ...
  // ../sdk-ui/node_modules/mdurl/lib/encode.mjs
  var encodeCache = {};
  ...
  // ../sdk-ui/node_modules/mdurl/lib/format.mjs
  function format(url) {
    let result = "";
    result += url.protocol || "";
    result += url.slashes ? "//" : "";
  ...
  // ../sdk-ui/node_modules/mdurl/lib/parse.mjs
  function Url() {
    this.protocol = null;
    this.slashes = null;
    this.auth = null;
  ...
  // ../sdk-ui/node_modules/uc.micro/index.mjs
  var uc_exports = {};
  __export(uc_exports, {
    Any: () => regex_default,
    Cc: () => regex_default2,
  ...
  // ../sdk-ui/node_modules/uc.micro/properties/Any/regex.mjs
  var regex_default = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/;

  // ../sdk-ui/node_modules/uc.micro/categories/Cc/regex.mjs
  var regex_default2 = /[\0-\x1F\x7F-\x9F]/;

  // ../sdk-ui/node_modules/uc.micro/categories/Cf/regex.mjs
  var regex_default3 = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/;

  // ../sdk-ui/node_modules/uc.micro/categories/P/regex.mjs
  var regex_default4 = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A
DFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA]/;

  // ../sdk-ui/node_modules/uc.micro/categories/Z/regex.mjs
  var regex_default6 = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/;

  // ../sdk-ui/node_modules/entities/lib/esm/generated/decode-data-html.js
  ...
  // ../sdk-ui/node_modules/entities/lib/esm/generated/decode-data-xml.js
  var decode_data_xml_default = new Uint16Array(
    // prettier-ignore
    "\u0200aglq	\x1B\u026D\0\0p;\u4026os;\u4027t;\u403Et;\u403Cuot;\u4022".split("").map((c) => c.charCodeAt(0))
  );

  // ../sdk-ui/node_modules/entities/lib/esm/decode_codepoint.js
  var _a;
  ...
  // ../sdk-ui/node_modules/entities/lib/esm/decode.js
  var CharCodes;
  (function(CharCodes2) {
  ...
  // ../sdk-ui/node_modules/entities/lib/esm/generated/encode-html.js
  ...
  // ../sdk-ui/node_modules/entities/lib/esm/escape.js
  ...
  // ../sdk-ui/node_modules/entities/lib/esm/index.js
  var EntityLevel;
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/helpers/index.mjs
  var helpers_exports = {};
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/helpers/parse_link_label.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/helpers/parse_link_destination.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/helpers/parse_link_title.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/renderer.mjs
  var default_rules = {};
...
`;
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/ruler.mjs
  function Ruler() {
    this.__rules__ = [];
    this.__cache__ = null;
  }
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/token.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/state_core.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/normalize.mjs
  var NEWLINES_RE = /\r\n?|\n/g;
  var NULL_RE = /\0/g;
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/block.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/inline.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/linkify.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/replacements.mjs
  var RARE_RE = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/;
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/smartquotes.mjs
  var QUOTE_TEST_RE = /['"]/;
  var QUOTE_RE = /['"]/g;
  var APOSTROPHE = "\u2019";
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_core/text_join.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/parser_core.mjs
  var _rules = [
    ["normalize", normalize],
    ["block", block],
    ["inline", inline],
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/state_block.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/table.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/code.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/fence.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/blockquote.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/hr.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/list.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/reference.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/common/html_blocks.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/common/html_re.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/html_block.mjs
  var HTML_SEQUENCES = [
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/heading.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/lheading.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_block/paragraph.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/parser_block.mjs
  var _rules2 = [
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/state_inline.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/text.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/linkify.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/newline.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/escape.mjs
  var ESCAPED = [];
  for (let i = 0; i < 256; i++) {
    ESCAPED.push(0);
  }
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/backticks.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/strikethrough.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/emphasis.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/link.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/image.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/autolink.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/html_inline.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/entity.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/balance_pairs.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/rules_inline/fragments_join.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/parser_inline.mjs
  var _rules3 = [
    ["text", text2],
    ["linkify", linkify2],
    ["newline", newline],
  ...
  // ../sdk-ui/node_modules/linkify-it/lib/re.mjs
  ...
  // ../sdk-ui/node_modules/linkify-it/index.mjs
  ...
  // ../sdk-ui/node_modules/punycode.js/punycode.es6.js
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/presets/default.mjs
  var default_default = {
    options: {
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/presets/zero.mjs
  var zero_default = {
    options: {
      // Enable HTML tags in source
      html: false,
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/presets/commonmark.mjs
  ...
  // ../sdk-ui/node_modules/markdown-it/lib/index.mjs
  var config = {
  ...
  // ../sdk-ui/dist/src/content-render.js
  ...
  var FORBIDDEN_TAGS = ["script", "style", "iframe", "img", "form", "input", "button"];
  var FORBIDDEN_ATTRS = ["style"];
  function isStringArray(value) {
    return Array.isArray(value) && value.every((item) => typeof item === "string");
  }
  function toTextualContent(source) {
  ...
  function toStructuredText(source) {
    if (source === null || source === void 0) {
      return "";
    }
    try {
  ...
  function sanitizeHtml(html2) {
    ...
    const purify2 = purify(currentWindow);
    purify2.addHook("uponSanitizeAttribute", (_node, data) => {
      if (/^on/i.test(data.attrName)) {
        data.keepAttr = false;
      }
    });
    const sanitized = purify2.sanitize(html2, {
      FORBID_TAGS: FORBIDDEN_TAGS,
      FORBID_ATTR: FORBIDDEN_ATTRS
    });
    purify2.removeAllHooks();
    const template = currentWindow.document.createElement("template");
    template.innerHTML = sanitized;
    for (const link2 of template.content.querySelectorAll("a")) {
  ...
  function renderAssistantMarkdown(source) {
    const text3 = toTextualContent(source);
    if (text3 === null) {
      return "";
    }
    const rendered = markdown.render(text3);
    return sanitizeHtml(rendered);
  }
  function renderUserText(source) {
  ...
  function renderChatMessageContent(message) {
    ...
    const isAssistantFinalAnswer = message.role === "assistant" && message.type === "chat::answer" && message.status === "final" && textualContent !== null;
  ...
  function appendCurrentRow(dom, state) {
  ...
  function appendStatusRow(dom, className, text3) {
    const row = document.createElement("div");
    row.className = className;
    row.textContent = text3;
  ...
  var HistoryController = class {
    ...
    async refresh() {
      ...
      try {
        ...
        const message = error2 instanceof Error ? error2.message : "Unable to load chats.";
        this.state.status = "error";
        this.state.errorMessage = message;
        this.callbacks.onError(error2, "history_refresh_failed", message);
        this.render();
      }
    }
    render() {
    ...
    async handleNewChatClick() {
      ...
      try {
        ...
        this.callbacks.onError(error2, "history_new_chat_failed", "New chat failed");
      }
    }
    async handleListClick(event) {
      ...
      if (toggleButton) {
        event.preventDefault();
        event.stopPropagation();
        const sessionId2 = toggleButton.dataset.sessionId ?? null;
        this.state.menuSessionId = this.state.menuSessionId === sessionId2 ? null : sessionId2;
        this.render();
        return;
      }
      const currentRow = target.closest('[data-live-current="true"]');
      if (currentRow) {
        event.preventDefault();
        this.state.selection = { kind: "current" };
        this.state.menuSessionId = null;
      ...
      const row = target.closest('[data-testid="history-row"]');
    ...
    async openHistorical(sessionId) {
      if (this.destroyed || !this.client) {
        return;
      }
      const client = this.client;
      ...
      try {
        ...
        this.callbacks.onError(error2, "history_load_failed", "History messages could not be loaded");
        this.render();
      }
    }
    async handleMenuAction(actionButton) {
      if (!this.client) {
        return;
      }
  ...
  function createHistoryDom() {
    ...
    const list2 = createElement2("div", "cortex-widget-history__list");
    list2.setAttribute("data-testid", "history-list");
    header.append(status, searchPlaceholder, newChatButton);
    panel.append(header, list2);
    root.append(panel);
    shadowRoot.append(style, root);
    return {
      host,
  ...
  function syncHeaderAvatar(avatarEl, title, avatarUrl) {
    ...
    if (avatarUrl) {
      let image2 = existingImage;
      if (!image2) {
        image2 = document.createElement("img");
        image2.alt = "";
        image2.setAttribute("aria-hidden", "true");
        avatarEl.appendChild(image2);
      }
      ...
      if (image2.getAttribute("src") !== avatarUrl) {
        image2.src = avatarUrl;
      }
      if (avatarEl.lastChild !== image2) {
        avatarEl.appendChild(image2);
      }
      return;
    }
  ...
  function renderWidget(dom, state, options, attachmentsAvailable, isUploading, opts) {
    ...
    const inputLocked = state.isDestroyed || state.chat.input.locked || state.isAwaitingAnswer || isUploading || questionLocksInput || state.isHistoricalView;
  ...
  var ChatWidget = class {
    constructor(args) {
      ...
      this.onComposerSubmit = (event) => {
        event.preventDefault();
        void this.handleSend();
      };
      this.onAttachClick = () => {
        if (!this.ui.attachmentsAvailable || this.ui.isUploading || this.ui.isAwaitingAnswer || this.getDisplayedChatState().input.locked) {
          return;
        }
      ...
      this.onAuthSubmitClick = () => {
        void this.handleLoginSubmit();
      };
      this.onAuthPasswordKeyDown = (event) => {
        if (event.key === "Enter") {
          event.preventDefault();
          void this.handleLoginSubmit();
        }
      ...
      this.debug = createDebugLogger2(args.options.debug);
      ...
      if (this.options.mode === "embedded" && this.historyTarget) {
        ...
        this.historyController = new HistoryController({
          ...
          callbacks: {
            ...
            onError: (error2, code2, message) => this.handleHistoryError(error2, code2, message)
          }
        });
    ...
    showHistoricalTranscript(sessionId, messages) {
      if (this.ui.isDestroyed) {
        return;
      }
    ...
    bindControllerListeners() {
      this.unsubscribeController = this.controller.subscribe((nextState) => {
...
${token}`;
  ...
  // src/mount.ts
  function callOnError(options, error2) {
  ...
  function assertBrowserEnvironment(options) {
    if (typeof window === "undefined" || typeof document === "undefined") {
      const error2 = createWidgetError("browser_unsupported", "Cortex Chat Widget requires a browser environment.");
      callOnError(options, error2);
      throw error2;
    }
    if (typeof HTMLElement === "undefined") {
      const error2 = createWidgetError("browser_unsupported", "HTMLElement is unavailable in the current environment.");
      callOnError(options, error2);
      throw error2;
    }
  }
  function resolveOptions(targetOrOptions, maybeOptions) {
    ...
    if (!baseOptions.apiKey) {
      const error2 = createWidgetError("missing_api_key", "Cortex Chat Widget requires apiKey.");
      callOnError(baseOptions, error2);
      throw error2;
    }
    return {
      ...baseOptions,
  ...
  function mountCortexChat(targetOrOptions, maybeOptions) {
    ...
    if (typeof HTMLElement.prototype.attachShadow !== "function") {
      const error2 = createWidgetError("shadow_dom_unsupported", "Cortex Chat Widget requires Shadow DOM support.");
      callOnError(options, error2);
      throw error2;
    }
